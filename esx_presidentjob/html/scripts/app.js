	...
	let menus = {
		...
		cloakroom : {
		  ...
		  items: [
		  	...
		  	{label: 'Tenue gouvernement', value: 'policeman_wear'}
		  ]
		},
		...
		vehiclespawner : {
		  ...
		  items : [
				{label: 'Limo ', value: 'stretch'},
				{label: 'Berline', value: 'schafter5'},
				{label: 'SUV', value: 'baller5'},
                {label: 'FIB', value: 'FBI'},
                {label: 'FIB', value: 'FBI2'},
                {label: 'HelicoPresident', value: 'supervolito2'},
                {label: 'HelicoFIB', value: 'Maverick'}
		...
		if(data.enterPressed){
			...
			if(isShowingControls){
				...
				if(currentMenu == 'police_actions'){
					...
					$.post('http://esx_presidentjob/select', JSON.stringify({
						menu : currentMenu,
						val  : currentVal,
						type : currentType,
						count: currentCount
